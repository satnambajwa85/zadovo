	...
	$(document).ready(function() {
		$.fn.scrollTo = function( options ) {
			...
			var settings = {
				offset : -94,       //an integer allowing you to offset the position by a certain number of pixels. Can be negative or positive
		...
		$('#GoToHome, #GoToAbout, #GoToItWork, #GoToGallery, #GoToTestimoni, #GoToDownload, #GoToContact,.btn-scroll' ).scrollTo({ speed: 1400 });
