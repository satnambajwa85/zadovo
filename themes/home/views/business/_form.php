...
<div id='step1'>
	...
	<div class="row">
		<a class="gradient-button nextStep"  >Next</a>
	</div>
</div>
<div id='step2' class='hide'>
	...
	<div class="row">
		<a class="gradient-button preStep"  >Previous</a>
		<a class="gradient-button nextStep"  >Next</a>
	</div>
</div>
<div  id='step3' class="hide">
	...
	<div class="row">
		...
		<img width="100" height="100" src="<?php echo Yii::app()->request->baseUrl.'/uploads/Business/sthumb/'.$model->image;?>" alt="image"/>
		<?php }?>
	</div>
