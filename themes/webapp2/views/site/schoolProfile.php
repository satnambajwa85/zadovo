			...
			<div class="col-md-6">
				<div class="span5 school-info">
					<div class="school-form2">
						...
						<ul>
							<li><span class="glyphicon glyphicon-earphone"></span><h3><?php echo $info->telephone;?></h3></li>
							<li><span class="glyphicon glyphicon-home"></span><h3><?php echo $info->address1;?></h3></li>
							
							<li><span class="glyphicon glyphicon-envelope"></span><?php echo CHtml::link('<h3>'.$info->email.'</h3>','mailto:'.$info->email.'')?></li>
							<li><span class="glyphicon glyphicon-copyright-mark"></span><?php echo CHtml::link('<h3>'.$info->website.'</h3>',''.$info->website.'',array('target'=>'_blank'))?></li>
						</ul>
					 </div>
				</div>
		</div>
