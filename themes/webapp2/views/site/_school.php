				...
				<div class="col-md-12 top-border">
					<div class="row design_s" >
						<div >
								<?php  
					$path	=	Yii::app()->baseUrl.'/uploads/SchoolsProfile/sthumb/';
					?> 
					<div class="fl p_img_outer" >
						
						<?php echo Chtml::link('<img width="180" height="150" src="'.$path.$data->logo.'" alt="'.$data->name.'"/>',array('/site/schoolProfile','id'=>$data->id));?>
					</div>
							<div class="col-md-6 fl">
                                ...
                                <div class="text_set">Telephone-<span>1221121212</span></div>
							<div class="text_set">address-<span> ffsfs</span></div>
							</div>
