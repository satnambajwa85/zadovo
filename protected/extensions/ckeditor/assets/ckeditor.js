...
(function () {
    ...
    (function () {
        ...
        var r = f,
            s = e.extend({}, r.$block, r.$listItem, r.$tableContent);
        ...
        var l = {
            ...
            exec: function (n) {
                ...
                if (n.config.fullPage) o = n.getData();
                    ...
                    q += '>';
                    o = n.config.docType + '<html dir="' + n.config.contentsLangDirection + '">' + '<head>' + s + '<title>' + n.lang.preview + '</title>' + '<link href="' + n.config.contentsCss + '" type="text/css" rel="stylesheet" _cktemp="true"/>' + '</head>' + q + n.getData() + '</body></html>';
                }
                var t = 640,
                    u = 420,
                    v = 80;
    ...
    i.toolbar_Basic = [
        ['Span','Bold', 'Italic', '-', 'NumberedList', 'BulletedList', '-', 'Link', 'Unlink', '-', 'About']
    ];
    i.toolbar_Full = [
        ...
        ['TextColor', 'BGColor'],
        ['Maximize', 'ShowBlocks', '-', 'About','Span']
    ];
    i.toolbar = 'Full';
    ...
    (function () {
        ...
        k.dialog.hbox.prototype = e.extend(new k.dialog.uiElement(), {
            getChild: function (J) {
                ...
                return K._.children[J[0]] && K._.children[J[0]].getChild ? K._.children[J[0]].getChild(J.slice(1, J.length)) : null;
            }
        }, true);
